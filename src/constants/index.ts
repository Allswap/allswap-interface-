import { ChainId, JSBI, Percent, Token, WETH } from 'allswap-sdk'
import { AbstractConnector } from '@web3-react/abstract-connector'
import { routerv2 } from '../allswap_address.json'
...
export const ROUTER_ADDRESS: { [key: string]: string } = {
  ...
  [ChainId.RINKEBY]: routerv2,
  [ChainId.GÖRLI]: routerv2,
  [ChainId.KOVAN]: routerv2,
  [ChainId.FANTOM]: routerv2,
  [ChainId.FANTOM_TESTNET]: '0x2785F3a74b8DB0353115227C8eB4467a7364c80B',
  [ChainId.MATIC]: routerv2,
  [ChainId.MATIC_TESTNET]: routerv2,
  [ChainId.XDAI]: routerv2,
  [ChainId.BSC]: routerv2,
  [ChainId.BSC_TESTNET]: routerv2,
  [ChainId.ARBITRUM]: routerv2,
  [ChainId.MOONBASE]: routerv2,
  [ChainId.AVALANCHE]: routerv2,
  [ChainId.FUJI]: routerv2,
  [ChainId.HECO]: routerv2,
  [ChainId.HECO_TESTNET]: routerv2,
  [ChainId.HARMONY]: routerv2,
  [ChainId.HARMONY_TESTNET]: routerv2,
  [ChainId.OKEX]: routerv2,
  [ChainId.OKEX_TESTNET]: routerv2
}
...
// MEGA
export const MEGA: ChainTokenMap = {
    [ChainId.MAINNET]: new Token(ChainId.MAINNET, '0x', 18, 'MEGA', 'MegaToken'),
    [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, '0x', 18, 'MEGA', 'MegaToken'),
    [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, '0x', 18, 'MEGA', 'MegaToken'),
    [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, '0x', 18, 'MEGA', 'MegaToken'),
    [ChainId.KOVAN]: new Token(ChainId.KOVAN, '0x', 18, 'MEGA', 'MegaToken'),
    [ChainId.FANTOM]: new Token(ChainId.FANTOM, '0x', 18, 'MEGA', 'MegaToken')
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
    [ChainId.MAINNET]: [
        [MEGA[ChainId.MAINNET] as Token, WETH[ChainId.MAINNET]],
        [
